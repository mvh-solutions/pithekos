...
function ParaRenderer({usj, marker, nPara, selectedPath, setSelectedPath, setUsjNode}) {
    return <p
        style={{
            display: "flex",
            flexDirection: "row",
...
function ChapterRenderer({usj, nPara, selectedPath, setSelectedPath, setUsjNode}) {
